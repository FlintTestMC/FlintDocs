...
[![SteelMC](https://dcbadge.limes.pink/api/server/MwChEHnAbh?style=social)](https://discord.gg/KJRkYKjMss)

<div align="center">

# Flint Docs

This is the main repository for the [Flint](https://github.com/FlintTestMC) documentation, made using [Astro Starlight](https://starlight.astro.build/).
...
```gitattributes
git clone https://github.com/{your-name}/FlintDocs
```
...
```gitattributes
origin   https://github.com/{your-name}/FlintDocs.git (fetch)
origin   https://github.com/{your-name}/FlintDocs.git (push)

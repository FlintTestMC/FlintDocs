...
description: Tests für Spieler-Block-Interaktionen mit use_item_on
sidebar:
  order: 3
---
...
```json
{
  "timeline": [
    ...
    { "at": 1, "do": "use_item_on", "pos": [0,0,0], "face": "top", "item": "minecraft:diamond_axe" },
...
```json
{ "at": 2, "do": "select_hotbar", "slot": 2 }
```

### Slot setzen

```json
{ "at": 5, "do": "set_slot", "slot": "hotbar1", "item": "minecraft:water_bucket", "count": 1 }
```

### Slot leeren

```json
{ "at": 10, "do": "set_slot", "slot": "hotbar1" }
```
